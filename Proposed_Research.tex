...
\end{enumerate}
\item \textit{Stage 3}: %Implementación y optimización de los algoritmos propuestos.
    Implementation and optimization of the proposed algorithms.
\item \textit{Stage 4}: %Dise\~no de experimentos y estrategia de validación de los algoritmos propuestos.
