...
\item Construction of the proposed models, that is to build an implementation in the Python or Julia language, of a single-pass Clustering algorithm capable of operating under scenarios in which the vectors, each one representing a document, are distributed into several computers (workers).
